    ...
    "render answer section for individual personal rep with a NINO, UK address and an email address" in {
      ...
      result mustBe AnswerSection(
        ...
        rows = Seq(
          ...
          AnswerRow(
            label = messages("personalRep.individual.email.checkYourAnswersLabel", name.displayName),
    ...
    "render answer section for individual personal rep with a passport and UK address" in {
      ...
      result mustBe AnswerSection(
        ...
        rows = Seq(
          ...
          AnswerRow(
            label = messages("personalRep.individual.passportOrIdCard.checkYourAnswersLabel", name.displayName),
            answer = Html("Passport"),
            None
          ),
          AnswerRow(
            label = messages("personalRep.individual.passport.checkYourAnswersLabel", name.displayName),
            answer = Html("United Kingdom<br />1234567890<br />3 February 2023"),
            None
          ),
          AnswerRow(
            label = messages("personalRep.individual.livesInTheUkYesNo.checkYourAnswersLabel", name.displayName),
    ...
    "render answer section for individual personal rep with an ID card and non-UK address" in {
      ...
      result mustBe AnswerSection(
        ...
        rows = Seq(
          ...
          AnswerRow(
            label = messages("personalRep.individual.idCard.checkYourAnswersLabel", name.displayName),
            answer = Html("United Kingdom<br />1234567890<br />3 February 2023"),
            None
          ),
          AnswerRow(
